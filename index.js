        ...
        db.query("DROP TABLE IF EXISTS producto;", (errDrop2) => {
            ...
            db.query(sqlTablaPlural, (errPlural) => {
                ...
                db.query(sqlTablaSingular, (errSingular) => {
                    ...
                    const listaAgropets = [
                      [7750100058, "Ricocan 7+ Años Adulto Raza Med/Gde x15kg", 24, 105.00, "Perros - Secos"],
                        [7750100059, "Ricocan Cordero y Cereales Adulto Raza Med/Gde x22kg", 28, 150.70, "Perros - Secos"],
                        [7750100060, "Ricocan Cordero y Cereales Adulto Raza Pequeña x15kg", 21, 105.00, "Perros - Secos"],
                        [7750100061, "Ricocan Multisabores Adultos Todas las Razas x22kg", 29, 150.70, "Perros - Secos"],
                        [7750100062, "Ricocan Original Adultos Todas las Razas x15kg", 25, 105.00, "Perros - Secos"],
                        [7750100063, "Ricocan Extruido Cachorros Carne/Leche Raza Peq x15kg", 22, 109.50, "Perros - Secos"],
                        [7750100064, "Ricocan Extruido Cachorros Carne/Leche Raza Med/Gde x22kg", 27, 157.50, "Perros - Secos"],
                        [7750100065, "Supercan Cachorros Carne y Leche x15kg", 30, 97.50, "Perros - Secos"],
                        [7750100066, "Supercan Adulto Carne y Cereales x25kg", 23, 140.00, "Perros - Secos"],
                        [7750100067, "Supercan Adulto Sabor Cordero x15kg", 26, 90.00, "Perros - Secos"],
                        [7750100068, "Supercan Adulto Buffet de Sabores x25kg", 20, 140.00, "Perros - Secos"],
                        [7750100069, "Yango Sabor Carne Adulto Todas las Razas x25kg", 24, 95.00, "Perros - Secos"],
                        [7750100070, "Bandido Extruido Adulto Carne x18kg", 28, 73.50, "Perros - Secos"],
                        [7750100071, "Thor Carne, Hígado y Cereales Adultos x25kg", 21, 107.50, "Perros - Secos"],
                        [7750100072, "Thor Carne Cachorros x25kg", 25, 112.50, "Perros - Secos"],
                        [7750100073, "Mimaskot Carne, Cereales y Vegetales x15kg", 29, 93.00, "Perros - Secos"],
                        [7750100074, "Mimaskot Adulto Carne, Pollo y Cereales Raza Peq x15kg", 22, 93.00, "Perros - Secos"],
                        [7750100075, "Mimaskot Adulto Carne, Pollo y Cereales Raza Peq x25kg", 27, 145.00, "Perros - Secos"],
                        [7750100076, "Mimaskot Carne/Cereales Cachorro Raza Med/Gde x15kg", 30, 93.00, "Perros - Secos"],
                        [7750100077, "Mimaskot Carne/Cereales Cachorro Raza Med/Gde x25kg", 23, 145.00, "Perros - Secos"],
                        [7750100078, "Mimaskot Carne/Cereales Cachorro Raza Pequeña x15kg", 26, 93.00, "Perros - Secos"],
                        [7750100079, "Nutrican Cachorro Perros x15kg", 24, 67.00, "Perros - Secos"],
                        [7750100080, "Nutrican Adulto Perros x15kg", 28, 69.00, "Perros - Secos"],
                        [7750100081, "Nutrican Adulto Perros x25kg", 21, 108.00, "Perros - Secos"],
                        [7750100082, "Zeus Adulto Perros x25kg", 25, 90.00, "Perros - Secos"],
                        [7750100083, "Zeus Cachorro Perros x25kg", 29, 93.00, "Perros - Secos"],
                        [7750100084, "Ricocat Festival de Sabores Adulto x15kg", 22, 133.00, "Gatos - Secos"],
                        [7750100085, "Ricocat Pollo, Sardina y Salmón Adulto x09kg", 27, 81.00, "Gatos - Secos"],
                        [7750100086, "Ricocat Carne, Salmón y Leche Adulto x09kg", 30, 81.00, "Gatos - Secos"],
                        [7750100087, "Ricocat Atún, Sardina y Trucha Adulto x09kg", 23, 81.00, "Gatos - Secos"],
                        [7750100088, "Ricocat Esterilizados Adulto x09kg", 26, 81.00, "Gatos - Secos"],
                        [7750100089, "Supercat Sardina, Atún y Trucha Adulto x09kg", 20, 70.50, "Gatos - Secos"],
                        [7750100090, "Supercat Carne y Leche Cachorros x09kg", 24, 67.50, "Gatos - Secos"],
                        [7750100091, "Ricocat Carne, Pescado y Leche Cachorro x15kg", 28, 111.00, "Gatos - Secos"],
                        [7750100092, "Michicat Pollo, Sardina y Atún Adulto x09kg", 21, 85.00, "Gatos - Secos"],
                        [7750100093, "Maxicat Pollo y Pescado Adulto x15kg", 25, 139.00, "Gatos - Secos"],
                        [7750100094, "Mimaskot Gatitos Pollo, Carne y Leche x9kg", 29, 75.00, "Gatos - Secos"],
                        [7750100095, "Mimaskot Gatos Adultos Salmón, Atún y Sardina x9kg", 22, 70.00, "Gatos - Secos"],
                        [7750100096, "Mimaskot Gatos Adultos Pollo, Carne y Salmón x9kg", 27, 70.00, "Gatos - Secos"],
                        [7750100097, "Nutrican Gatos Atún y Sardina x9kg", 30, 58.00, "Gatos - Secos"],
                        [7750100098, "Nutrican Gatos Adultos x25kg", 23, 110.00, "Gatos - Secos"],
                        [7750100099, "Arena Sanitaria Mimaskot para Gatos x5kg", 26, 13.00, "Gatos - Arena"],
                        [7750100100, "Arena Sanitaria Mimaskot para Gatos x10kg", 20, 23.00, "Gatos - Arena"],
                        [7750100101, "Arena Sanitaria Mimaskot para Gatos x20kg", 24, 40.00, "Gatos - Arena"],
                        [7750100102, "Caja Latas Ricocan Pate/Trocitos x24und (330gr)", 28, 102.00, "Húmedos"],
                        [7750100103, "Caja Latas Ricocat Húmedo Pate x24und (330gr)", 21, 115.00, "Húmedos"],
                        [7750100104, "Caja Pouches Ricocan Trocitos x15und (100gr)", 25, 25.00, "Húmedos"],
                        [7750100105, "Caja Pouches Ricocat Húmedo x15und (85gr)", 29, 26.00, "Húmedos"],
                        [7750100106, "Caja Latas Thor Adulto/Cachorro x24und (330gr)", 22, 92.00, "Húmedos"],
                        [7750100107, "Caja Latas Supercan Guisos x24und (280gr)", 27, 81.00, "Húmedos"],
                        [7750100108, "Shampoo Ricocan Frasco x380ml", 30, 12.00, "Higiene"],
                        [7750100109, "Shampoo Fresh Can Frasco x300ml", 23, 8.00, "Higiene"],
                        [7750100110, "Snack Ricocrack Caja x12und", 26, 72.00, "Snacks"],
                        // 🌾 Línea Agrícola (IDs adaptados numéricamente para compatibilidad)
                        [8001, "Super Plus Inicio Pellet 40kg (B001)", 20, 117.00, "Agrícola - Aves"],
                        [8002, "Super Plus Crecimiento Pellet 40kg (B002)", 24, 115.00, "Agrícola - Aves"],
                        [8003, "Super Plus Engorde Pellet 40kg (B003)", 28, 110.00, "Agrícola - Aves"],
                        [8004, "Polvo Super Plus Inicio Harinado 40kg (B004)", 21, 99.00, "Agrícola - Aves"],
                        [8005, "Polvo Super Plus Crecimiento Harinado 40kg (B005)", 25, 98.00, "Agrícola - Aves"],
                        [8006, "Polvo Super Plus Engorde Harinado 40kg (B006)", 29, 94.00, "Agrícola - Aves"],
                        [8007, "Hi Premium Buenamicyn-a Etts 40kg (B007)", 22, 130.00, "Agrícola - Aves"],
                        [8008, "Hi Premium Buenamicyn-a 20x1kg Etts 20kg (B008)", 27, 76.00, "Agrícola - Aves"],
                        [8009, "Hi Premium Buenamicyn-a Micro Pellet 40kg (B009)", 30, 135.00, "Agrícola - Aves"],
                        [8010, "Hi Premium Inicio Etts 40kg (B010)", 23, 119.00, "Agrícola - Aves"],
                        [8011, "Hi Premium Crecimiento Pellet 40kg (B011)", 26, 120.00, "Agrícola - Aves"],
                        [8012, "Hi Premium Engorde Pellet 40kg (B012)", 20, 118.00, "Agrícola - Aves"],
                        [8013, "Postura Hi Premium Pellet 40kg (B013)", 24, 110.00, "Agrícola - Aves"],
                        [8014, "Postura Hi Premium Polvo Harinado 40kg (B014)", 28, 96.00, "Agrícola - Aves"],
                        [8015, "Conejo Plus Hi-T Crecimiento Pellet 40kg (B015)", 21, 92.00, "Agrícola - Mamíferos"],
                        [8016, "Conejo Plus Hi-R Reproductora Pellet 40kg (B016)", 25, 95.00, "Agrícola - Mamíferos"],
                        [8017, "Cuy Plus Hi-E Crecimiento Pellet 40kg (B017)", 29, 95.00, "Agrícola - Mamíferos"],
                        [8018, "Cuy Plus Hi-R Reproductora Pellet 40kg (B018)", 22, 90.00, "Agrícola - Mamíferos"],
                        [8019, "Cuy Hi Premium Crecimiento Polvo Harinado 40kg (B019)", 27, 86.00, "Agrícola - Mamíferos"],
                        [8020, "Pura Casta Inicio Etts 40kg (B020)", 30, 122.00, "Agrícola - Gallos"],
                        [8021, "Pura Casta Crecimiento Pellet 40kg (B021)", 23, 117.00, "Agrícola - Gallos"],
                        [8022, "Pura Casta Acabado Pellet 40kg (B022)", 26, 112.00, "Agrícola - Gallos"],
                        [8023, "Pura Casta Muda Pellet 40kg (B023)", 20, 123.00, "Agrícola - Gallos"],
                        [8024, "Cerdos Eco Pig 1 Micro Pellet 25kg (B024)", 24, 145.00, "Agrícola - Cerdos"],
                        [8025, "Cerdos Eco Pig 2 Micro Pellet 25kg (B025)", 28, 127.00, "Agrícola - Cerdos"],
                        [8026, "Cerdos Eco Pig 3 Micro Pellet 25kg (B026)", 21, 109.00, "Agrícola - Cerdos"],
                        [8027, "Cerdos Gestación Hi Pig Harinado Polvo 40kg (B027)", 25, 76.00, "Agrícola - Cerdos"],
                        [8028, "Cerdos Lactancia Hi Pig Harinado Polvo 40kg (B028)", 29, 99.00, "Agrícola - Cerdos"],
                        [8029, "Cerdos Inicio 7+ Hi Pig Polvo Harinado 40kg (B029)", 22, 127.00, "Agrícola - Cerdos"],
                        [8030, "Cerdos Inicio 12+ Hi Pig Polvo Harinado 40kg (B030)", 27, 109.00, "Agrícola - Cerdos"],
                        [8031, "Cerdos Eco Pig 2 Polvo Harinado 40kg (B031)", 30, 176.00, "Agrícola - Cerdos"],
                        [8032, "Cerdos Eco Pig 3 Polvo Harinado 40kg (B032)", 23, 149.00, "Agrícola - Cerdos"],
                        [8033, "Cerdos Crecimiento Hi Pig (1) Harinado Polvo 40kg (B033)", 26, 96.00, "Agrícola - Cerdos"],
                        [8034, "Cerdos Crecimiento Hi Pig (2) Harinado Polvo 40kg (B034)", 20, 90.00, "Agrícola - Cerdos"],
                        [8035, "Cerdos Engorde Hi Pig Polvo Harinado 40kg (B035)", 24, 94.00, "Agrícola - Cerdos"],
                        [8036, "Pavo Hi Premium Inicio Etts 40kg (B036)", 28, 133.00, "Agrícola - Pavos"],
                        [8037, "Pavo Hi Premium Crecimiento Pellet 40kg (B037)", 21, 116.00, "Agrícola - Pavos"],
                        [8038, "Pavo Hi Premium Acabado Pellet 40kg (B038)", 25, 113.00, "Agrícola - Pavos"],
                        // 🛒 Línea Comercial
                        [9001, "Mercado Crecimiento Pellet 40kg (C001)", 29, 60.00, "Agrícola - Comercial"],
                        [9002, "Mercado Engorde Pellet 40kg (C002)", 22, 60.00, "Agrícola - Comercial"],
                        [9003, "Carne Crecimiento Pellet 40kg (C003)", 27, 70.00, "Agrícola - Comercial"],
                        [9004, "Carne Engorde Pellet 40kg (C004)", 30, 70.00, "Agrícola - Comercial"],
                        [9005, "Concentrado Mercado Carne Harinado 40kg (C005)", 23, 65.00, "Agrícola - Comercial"],
                        [9006, "Super Carne Inicio Etts 40kg (C006)", 26, 101.00, "Agrícola - Comercial"],
                        [9007, "Super Carne Crecimiento Pellet 40kg (C007)", 20, 101.00, "Agrícola - Comercial"],
                        [9008, "Super Carne Engorde Pellet 40kg (C008)", 24, 101.00, "Agrícola - Comercial"],
                        [9009, "Cuy Carne Pellet 40kg (C009)", 28, 78.00, "Agrícola - Comercial"],
                        [9010, "Cuy Carne Polvo Harinado 40kg (C010)", 21, 73.00, "Agrícola - Comercial"],
                        [9011, "Conejo Carne Pellet 40kg (C011)", 25, 80.00, "Agrícola - Comercial"]
                    ];
